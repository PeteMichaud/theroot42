...
ActiveRecord::Schema.define(:version => 20121109205912) do
  ...
  create_table "users", :force => true do |t|
    ...
    t.text     "profile"
    t.enum     "account_type",           :limit => [:user, :moderator, :admin], :default => :user
  ...
  add_index "votes", ["user_id", "comment_id"], :name => "index_votes_on_user_id_and_comment_id"
